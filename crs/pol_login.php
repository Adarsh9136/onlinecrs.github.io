...
<head>
  ...
  <title>CRT Project By Adarsh & Amish</title>
...
<body style="color: white;background-image: url(police.jpg);background-size: 100%;background-repeat: no-repeat;back">
  ...
  <nav class="navbar navbar-default">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active nav-items"><a href="#">Police Login</a></li>
      </ul>
    ...
    <div class="center-container">
      <div class="bg-agile">
        <div class="login-form">
          ...
          <h2 style="margin-bottom: 6px;">Police Login</h2>
          <form method="post">
            <div class="mb-3">
            <label for="exampleInputEmail1"  ><h5 style="color:white">Police Id</h5></label>
            <input type="text" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" size="5" placeholder="Enter user id" required onfocusout="f1()">            </div><br>
            <div class="mb-3">
            <label for="exampleInputPassword1"><h5 style="color:white">Password</h5></label>
