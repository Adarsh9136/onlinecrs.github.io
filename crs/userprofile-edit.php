...
if (!isset($_SESSION['x']))
    ...
    header("location:userprofile.php.php");
...
if(isset($_POST['edit'])){
    ...
    $sql = "UPDATE `user` SET `mob` = '$mob',`a_no` = '$a_no',`u_addr` = '$u_addr' WHERE `user`.`u_id` = '$u_id' ";   
...
<body>
    ...
    <nav class="navbar navbar-default">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-items"><a href="user_profile.php">Profile</a></li>
                <li class="active nav-items"><a href="#">Update Profile</a></li>
            </ul>
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control input" id="fullName" placeholder="Enter full name" value=" <?php echo $u_name ?>" >
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="eMail">Email</label>
                                        <input aria-required="true" disabled type="email" class="form-control input" id="eMail" placeholder="Enter email ID" value=<?php echo $u_id ?>>
                                    </div>
                                </div>
                                <form method="post">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input aria-required="true" type="number" name="phone" class="form-control input" id="phone" placeholder="Enter phone number" value=<?php echo "$mob" ?>>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="website">Aadhaar</label>
                                        <input disabled type="number" class="form-control input" name="aadhar" id="aadhar" placeholder="Aadhaar number" value=<?php echo "$a_no" ?>>
                                    </div>
                                </div>
                            </div>
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input aria-required="true" type="text" class="form-control input" id="address" name="address"  placeholder="Enter Address" value="<?php echo $u_addr ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row gutters">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-right">
                                        <br>
                                        <span id="demo"></span>
                                        <a id="cancel" class="btn btn-secondary" href="user_profile.php">Cancel</a>
                                        <button id="save" type="submit" class="btn btn-primary"  name="edit" onclick="myFunction()">Save</button>
                                    </div>
                                    </form>
                                </div>
                            </div>
    ...
    <script>
        function myFunction() {
            if (confirm("Changes saved successfully.")){ }
