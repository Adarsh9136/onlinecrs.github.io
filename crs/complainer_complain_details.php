...
<head>
  ...
  <?php
    ...
    $query="select c_id,type_crime,d_o_c,location,inc_status,pol_status from complaint natural join user where c_id='$c_id' and u_id='$u_id'";
  ...
  ?>
    ...
    <body style="background-color:#452145;">
            ...
            <table class="table table-bordered">
               <thead class="thead-dark" style="background-color: blue; color: white;">
                   <tr>
                        ...
                        <th scope="col">Updates of the case</th>
                   </tr>
               </thead>
            <?php
                while($rows1=mysqli_fetch_assoc($res2)){
             ?> 
                <tbody style="background-color: white; color: blue;">
                <tr>
