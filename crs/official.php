  ...
  <nav class="navbar navbar-default"">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul style="padding-right: 15px " id="navb" class="nav navbar-nav navbar-right">
        ...
        <li><a href="userlogin.php" class="nav-items"><i class="fa fa-users" aria-hidden="true"></i>
            User</a></li>
        <li  class="active nav-items"><a href="official.php" class="nav-items"><i class="fa fa-user"></i> Official</a></li>
      </ul>
                ...
                <div class="thumbnail">
                    <div class="caption">
                        <h3>Police Login</h3>
                        <p>
                            <a href="pol_login.php" class="btn btn-primary">Police Login</a>
                        </p>
                ...
                <div class="thumbnail">
                    <div class="caption">
                        <h3>Police Station(Incharge) Login</h3>
                        <p>
                            <a href="inc_login.php" class="btn btn-primary">Incharge Login</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="thumbnail">
                    <div class="caption">
                        <h3>Headoffice Login</h3>
                        <p>
                            <a href="head_login.php" class="btn btn-primary">Headoffice Login</a>
                        </p>
