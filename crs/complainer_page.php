...
<body style="color: white;background-image: url(bl.jpg);background-size: 100%;background-repeat: no-repeat;back">
  ...
  <nav class="navbar navbar-default">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active nav-items"><a href="#">New Complain</a></li>
      </ul>
