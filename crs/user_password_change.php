...
$result = mysqli_query($conn, "SELECT u_pass FROM user where u_id='$u_id' ");
...
if(isset($_POST['change'])){
    ...
    $new=$_POST['newpass'];
    if($u_pass==$old){
    $sql = "UPDATE `user` SET `u_pass` = '$new' WHERE `user`.`u_id` = '$u_id' ";   
                            ...
                            <div class="panel-body">
                                <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="ans">@Change password</label>
                                        <input onfocus="this.value=''" aria-required="true" type="name" class="form-control input" id="oldpass" required name="oldpass" placeholder="Old Password">
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-key color-blue"></i></span>
                                            <input onfocus="this.value=''" aria-required="true" id="newpass" required name="newpass" placeholder="New Password" class="form-control" type="password">
                                        </div>
                                    </div>
                                    <div class="form-group">

                                        <button id="save" type="submit" class="btn btn-lg btn-primary btn-block" onclick="myFunction()" name="change">Reset password</button>
