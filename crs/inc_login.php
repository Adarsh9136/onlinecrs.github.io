  ...
  <nav class="navbar navbar-default">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active nav-items"><a href="#">Incharge Login</a></li>
      </ul>
    ...
    <div class="center-container">
      <div class="bg-agile">
        <div class="login-form">
          ...
          <h2 style="margin-bottom: 6px;">Incharge Login</h2>
          <form method="post">
            <div class="mb-3">
            <label for="exampleInputEmail1"  ><h5 style="color:white">Incharge Id</h5></label>
